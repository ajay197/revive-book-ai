...
const CTASection = () => (
  <section className="relative overflow-hidden bg-gradient-primary py-16 sm:py-24">
    <div className="pointer-events-none absolute inset-0">
      <div className="absolute -left-20 -top-20 h-60 w-60 rounded-full border border-white/10 sm:h-80 sm:w-80" />
      <div className="absolute -bottom-32 -right-32 h-72 w-72 rounded-full border border-white/5 sm:h-96 sm:w-96" />
    </div>
