            ...
            <div className="grid grid-cols-2 gap-3 p-4 sm:gap-4 sm:p-6 md:grid-cols-4">
              {[
                ...
                >
                  ...
                  <p className="mt-1 font-display text-lg font-bold text-foreground sm:text-xl md:text-2xl">{stat.value}</p>
                  <p className="mt-1 text-xs font-medium text-success">{stat.change}</p>
                </motion.div>
              ))}
            </div>
            <div className="px-4 pb-4 sm:px-6 sm:pb-6">
              <div className="flex h-20 items-end gap-1 rounded-lg bg-muted/20 p-3 sm:h-28 sm:p-4">
