...
const testimonials = [
  ...
  { name: "Marcus T.", role: "Agency Owner", quote: "I manage 12 clients on { name: "Marcus T.", role: "Agency Owner", quote: "I manage 12 clients on Ryngr AI. The multi-tenant workspace feature saves me hours every day.", stars: 5 },. The multi-tenant workspace feature saves me hours every day.", stars: 5 },
