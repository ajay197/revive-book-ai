        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="mx-auto mt-16 grid max-w-5xl gap-8 lg:grid-cols-2">
            ...
            <div className="space-y-3">
              {[
                { credits: "500 Credits", perCredit: "1,250 minutes of calling", price: "$500", note: null, promo: null },
                { credits: "2,100 Credits", perCredit: "5,250 minutes of calling · +5% bonus", price: "$2,000", note: null, promo: null },
                { credits: "6,000 Credits", perCredit: "15,000 minutes of calling · +20% bonus", price: "$5,000", note: null, promo: { label: "Most Popular", tag: "Best Value" } },
              ].map((pack, i) => (
